...
<div style="padding:20px 0;max-width:800px" class="container">
    <h4 style="padding:0 0 20px 0;margin-bottom:35px;" class="border-bottom">Receber Conta</h4>
    <form action="atualizar_conta_recebida.php" method="POST">
        <?php
        ...
        while ($array = mysqli_fetch_array($retorno, MYSQLI_ASSOC)) {
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="data_venda" name="data_venda" placeholder="Data da Venda"
                    required autocomplete="off" value="<?= $data_venda ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="data_recebimento">Qual a data de Recebimento dessa conta?</label>
                <input type="date" class="form-control" id="data_recebimento" name="data_recebimento"
                    placeholder="Data de Recebimento" required autocomplete="off">
            </div>


            <input style="display:none" id="status" name="status">
            <button type="submit" class="btn-enviar btn btn-primary btn-sm btn-block">Receber</button>
            <a href="listar_contas_receber.php" class="btn-enviar btn btn-primary btn-sm btn-block">Cancelar</a>
        <?php } ?>
    </form>
</div>