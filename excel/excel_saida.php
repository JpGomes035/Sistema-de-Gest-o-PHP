...
// Consulta SQL para obter os dados da tabela "saida"
$sql_saida = "SELECT id, quantos, descricao, fmpag, responsavel, data, datareg, id_reg, nomeBanco FROM `saida` WHERE deletado = 'N'";
$resultado_saida = mysqli_query($conexao, $sql_saida);

// Cabeçalho para forçar o download de um arquivo Excel
header("Content-Type: application/vnd.ms-excel");
header("Content-Disposition: attachment; filename=relatorio_saida.xls");

// Inicializar a saída do Excel
echo '<table>';
echo '<tr><th>ID</th><th>Valor</th><th>Descrição</th><th>Forma de Pagamento</th><th>Responsável</th><th>Data</th><th>Data de Registro</th><th>Usuário que registrou</th><th>Nome do Banco</th></tr>';
$total = 0;
// Loop para a tabela "saida"
while ($row = mysqli_fetch_assoc($resultado_saida)) {
    echo '<tr>';
