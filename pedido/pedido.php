...
<body>
    <div style="margin-top: 50px;"> <!-- Adicione um espaço no topo para não cobrir o menu -->
        ...
        <p><i class="fa fa-exclamation" aria-hidden="true"></i> O estoque dos produtos será subtraido caso a opção <b style="color: blue">DESCONTAR ESTOQUE</b> seja marcada </p>
        <p><i class="fa fa-times" aria-hidden="true"></i> O Pedido não será realizado caso a quantidade da venda seja maior
            do que a quantidade do estoque</p>
            ...
            <div class="form-group">
                ...
                <div id="produtos" class="form-control">
                    ...
                    <select name="produtos[]" required>
                        ...
                        $sql = "SELECT idProduto, Nome, precovenda, img_prod, Quantidade 
                        FROM estoque 
                        WHERE deletado = 'N' 
                        ORDER BY Nome ASC";
                        ...
                        while ($linha = mysqli_fetch_assoc($resultado)) {
                            ...
                            $valor_unitario_prod = $linha['precovenda'];
                            $quantidade_estoque = $linha['Quantidade'];
                            $img_prod = $linha['img_prod'];
                            echo "<option value='$idProduto'> $nomeProduto | Preço: $valor_unitario_prod | Estoque: $quantidade_estoque </option>"; // Alteração aqui
                        }
                ...
                <label for="descontar_estoque">Descontar do Estoque:</label>
                <input type="checkbox" id="descontar_estoque" name="descontar_estoque" value="1"> <- DESCONTAR
                    <br>
                    <br>
                    <label for="adicionar_valor">Adicionar valor ao banco?</label>
                    <input type="checkbox" id="adicionar_valor" name="adicionar_valor" value="1"> <- Adicionar valor
                        ...
                        <a href="../lista_pedidos.php" class="listagem">Listagem</a>
        </form>
    </div>
    <script>
        function toggleMenu() {
