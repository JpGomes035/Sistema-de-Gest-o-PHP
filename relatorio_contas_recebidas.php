...
<body>
    ...
    <h1>Filtro de Recebimentos (Data de Recebimento)</h1>
    ...
    if (isset($_GET['dataInicio']) && isset($_GET['dataFim'])) {
        ...
        $sql = "SELECT * FROM contas_receber WHERE data_recebimento BETWEEN '$dataInicio' AND '$dataFim' AND status = 'S'";
    ...
    <div class="registro">
            ...
            <tbody>
                ...
                if (mysqli_num_rows($resultado) > 0) {
                    ...
                    while ($array = mysqli_fetch_array($resultado, MYSQLI_ASSOC)) {
                        ...
                        $data_recebimento = $array['data_recebimento'];
                        ...
                        $data_recebimento_original = $data_recebimento;
                        $timestamp = strtotime($data_recebimento_original);
                        $data_formatada_recebimento = date("d/m/y", $timestamp)
        ...
        if (isset($_GET['dataInicio']) && isset($_GET['dataFim'])) {
            ...
            if (mysqli_num_rows($resultado) > 0) {
                ...
                echo '<span style="color: black;"><br><b>  O total de Recebimento no intervalo de datas é:</span><span style="color: blue;"> R$:' . number_format($total, 2, ',', '') . '</b></span>';
            } else {
    ...
    <br>
    <b><a href="relatorios.php">Voltar</a></b>
</body>
