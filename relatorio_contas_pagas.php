...
<body>
    ...
    <h1>Filtro de Pagamento (Data de Pagamento)</h1>
    ...
    if (isset($_GET['dataInicio']) && isset($_GET['dataFim'])) {
        ...
        $sql = "SELECT * FROM contas_pagar WHERE data_pagamento BETWEEN '$dataInicio' AND '$dataFim' AND status = 'S'";
    ...
    <div class="registro">
            ...
            <tbody>
                ...
                if (mysqli_num_rows($resultado) > 0) {
                    ...
                    while ($array = mysqli_fetch_array($resultado, MYSQLI_ASSOC)) {
                        ...
                        $data_pagamento_original = $data_pagamento;
                        $timestamp = strtotime($data_pagamento_original);
                        $data_formatada_pagamento = date("d/m/y", $timestamp)
        ...
        if (isset($_GET['dataInicio']) && isset($_GET['dataFim'])) {
            ...
            if (mysqli_num_rows($resultado) > 0) {
                ...
                echo '<span style="color: black;"><br><b> O total de pagamentos no intervalo de datas é:</span><span style="color: red;"> R$:' . number_format($total, 2, ',', '') . '</b></span>';
            } else {
