...
$sql = "UPDATE pedido_compra SET fm_pag = '$fm_pag', banco_receb = '$banco_receb', observacoes = '$observacoes', valor_total = '$valor_total', responsavel_pedido = '$responsavel_pedido' WHERE codigo_pedido = $codigo_pedido";
$update = mysqli_query($conexao, $sql);

// Verifique se a atualização foi bem-sucedida
if ($update) {
    header("Location: lista_pedido_compras.php?atualizado=" . $codigo_pedido);
    exit();
} else {
