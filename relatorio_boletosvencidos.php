...
<head>
    ...
    <title>Relatório de Boletos Vencidos</title>
    <style>
        body {
...
<body>
    ...
    <h1>Filtro de Boletos Vencidos (Data de vencimento)</h1>
    ...
    if (isset($_GET['dataInicio']) && isset($_GET['dataFim'])) {
        ...
        $sql = "SELECT * FROM boletos WHERE data_vencimento BETWEEN '$dataInicio' AND '$dataFim' AND status_pagamento = 'Vencido' AND deletado = 'N'";
    ...
    <table>
        ...
        if (isset($_GET['dataInicio']) && isset($_GET['dataFim'])) {
            ...
            if (mysqli_num_rows($resultado) > 0) {
                ...
                echo '<span style="color: black;"><br> O total de boletos Vencidos no intervalo de datas é:</span><span style="color: red;"><b> R$:' . number_format($total, 2, ',', '') . '</b></span>';
            } else {
