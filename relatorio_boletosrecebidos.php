...
<head>
    ...
    <title>Relatório de Boletos Recebidos</title>
    <style>
        body {
...
<body>
    ...
    <h1>Filtro de Boletos Recebidos(Data de vencimento)</h1>
    ...
    if (isset($_GET['dataInicio']) && isset($_GET['dataFim'])) {
        ...
        $sql = "SELECT * FROM boletos WHERE data_vencimento BETWEEN '$dataInicio' AND '$dataFim' AND status_pagamento = 'Recebido' AND deletado = 'N'";
    ...
    <table>
        ...
        if (isset($_GET['dataInicio']) && isset($_GET['dataFim'])) {
            ...
            if (mysqli_num_rows($resultado) > 0) {
                ...
                echo '<span style="color: black;"><br><b>O total de boletos Recebidos no intervalo de datas é: </span><span style="color: red;"> R$:' . number_format($total, 2, ',', '') . '</b></span>';
            } else {
